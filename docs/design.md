...
| Command                         | Description                                                                                      |
| ------------------------------- | ------------------------------------------------------------------------------------------------ |
| `snapback init`                 | Interactive config bootstrap — discovers VMs by scanning `~/Virtual Machines` and `~/Virtual Machines.localized` for `.vmwarevm` bundles, prompts for destination/retention (falls back to manual entry if none are found) |
